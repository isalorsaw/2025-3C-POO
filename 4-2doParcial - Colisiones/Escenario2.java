...
public class Escenario2 extends JPanel implements MouseListener,KeyListener //implementar los eventos del mouse
{
    int nivelact;
    Fondo f;
    Carrito c;
    ...
    JFrame formPral;
    public Escenario2(int nivel,JFrame form)
    {
        formPral=form;
        nivelact=nivel;
        ...
        setPiedra("imagenes/carrito.png");
        crearGotas();
        got=null;
    ...
    public void detectarChoqueGotCar()
    {
        for(int i=0;i<gots.size();i++)
        {
            boolean choq=gots.get(i).choque(c.rec);
            if(choq)System.out.println("Se detecto un CHoque Gota Carro");
        }
    }
    public void lluvia()
    {
    ...
    public void setPiedra(String ruta)
    {
        pie=new Piedra(500,580,ruta);
    }
    ...
    public void crearGotas()
    {
        for(int i=0;i<30;i++)
        {
            int x=ClaseFM.generaAleatorio(10,f.ancho);
            int y=ClaseFM.generaAleatorio(10,300);
            Gota gotts = new Gota(x,y,"imagenes/gota.png");
            gots.add(gotts);
        }
    }
    ...
    public void paint(Graphics g)
    {
        ...
        g.drawString("Nivel "+nivelact+" "+c.toString()+" "+puntogota,10,f.alto+30);
